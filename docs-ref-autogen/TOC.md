...
#### [Enumerar ediciones](sql\db.pycliyml#list-editions "az sql db list-editions")
...
#### [Enumerar ediciones](sql\elastic-pool.pycliyml#list-editions "az sql elastic-pool list-editions")
