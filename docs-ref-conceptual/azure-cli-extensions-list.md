...
| [azure-cli-ml](https://docs.microsoft.com/en-us/azure/machine-learning/service/) | 1.0.53.1 | Módulo de comandos de AzureML de la herramienta de línea de comandos de Microsoft Azure |  |
