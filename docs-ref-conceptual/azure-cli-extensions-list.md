...
| [dev-spaces-preview](https://github.com/Azure/azure-cli-extensions) | 0.1.0 | Dev Spaces proporciona a los equipos una experiencia de desarrollo en Kubernetes iterativa y rápida. | Sí |
...
| [storage-preview](https://github.com/Azure/azure-cli-extensions) | 0.1.1 | Proporciona una versión preliminar de las características de almacenamiento futuras. | Sí |
