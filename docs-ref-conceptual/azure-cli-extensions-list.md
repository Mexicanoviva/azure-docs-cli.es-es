...
| [aks-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.42 | Proporciona una versión preliminar de las futuras características de AKS | Sí |
...
| [azure-devops](https://github.com/Microsoft/azure-devops-cli-extension) | 0.18.0 | Herramientas para administrar Azure DevOps. |  |
...
| [blueprint](https://github.com/Azure/azure-cli-extensions) | 0.1.0 | Extensión de plano técnico de las herramientas de línea de comandos de Microsoft Azure |  |
...
| [databricks](https://github.com/Azure/azure-cli-extensions) | 0.1.0 | Extensión de DatabricksClient de las herramientas de línea de comandos de Microsoft Azure |  |
...
| [front-door](https://github.com/Azure/azure-cli-extensions/tree/master/src/front-door) | 1.0.6 | Administración de redes de Front Door. |  |
...
| [interactive](https://github.com/Azure/azure-cli) | 0.4.4 | Shell interactivo de la línea de comandos de Microsoft Azure | Sí |
...
| [notification-hub](https://github.com/Azure/azure-cli-extensions) | 0.2.0 | Extensión de centro de notificaciones de la línea de comandos de Microsoft Azure |  |
...
| [support](https://github.com/azure/azure-cli-extensions/tree/master/src/support) | 1.0.1 | Extensión de soporte de las herramientas de línea de comandos de Microsoft Azure |  |
