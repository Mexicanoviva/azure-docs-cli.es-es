...
| [keyvault-preview](https://github.com/Azure/azure-keyvault-cli-extension) | 0.1.2 | Comandos de Azure Key Vault en versión preliminar. | Sí |
...
| [webapp](https://github.com/Azure/azure-cli-extensions) | 0.2.2 | Extensión de la CLI de Azure para administrar recursos de appservice | Sí |
