...
| [aks-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.2 | Proporciona una versión preliminar de las futuras características de AKS | Sí |
...
| [azure-cli-ml](https://docs.microsoft.com/en-us/azure/machine-learning/service/) | 1.0.41.1 | Módulo de comandos de AzureML de la herramienta de línea de comandos de Microsoft Azure |  |
