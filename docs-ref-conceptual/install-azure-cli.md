...
La versión actual de la CLI es la __2.0.31__. Para más información sobre la versión más reciente, consulte las [notas de la versión](release-notes-azure-cli.md).
